...
<body <?php body_class(); ?> >
	<div class='pvfw-not-allowed'>
		...
		<a class='tnc-btn tnc-go-home-btn' href='<?php echo home_url(); ?>'><?php echo esc_html_e( "Go To Homepage", $domain = 'pdf-viewer-for-wordpress' ) ?></a>
	</div>
</body>
</html>
...
<head>
	...
	<style type="text/css">
		...
		#loadingBar{
			background: <?php echo esc_attr( $tnc_primary_color ); ?>;
			border-bottom: 1px solid <?php echo esc_attr( $tnc_primary_color ); ?>;
		}
		#tnc-share{
			display: none;
...
<?php
	if ( $context_menu_setting == 'disable' ) {
...
<script type="text/javascript">
		document.onkeydown = function (e) {
			...
			if (e.ctrlKey) {
				...
				switch (c) {
					...
					<?php if ( $copying_setting == 'disable' ) { ?>
					case 67://Block cmd+c
					<?php } ?>
	  ...
	  <div class="tnc-pdf-back-to-btn">
		<a href="<?php echo esc_html( $_SERVER['HTTP_REFERER'] ); ?>">
		  <?php
