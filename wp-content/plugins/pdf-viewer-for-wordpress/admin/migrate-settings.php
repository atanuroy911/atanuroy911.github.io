	...
	<div id="poststuff">
	    <div id="post-body">
		    <div class="tnc-upload-container">
		    	...
		    	<p><?php echo esc_html_e( "2. Navigate to PDF Viewer > Global Settings > Export/Import Menu", $domain = 'pdf-viewer-for-wordpress' ); ?></p>
