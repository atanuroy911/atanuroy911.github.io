    ...
    <div id="poststuff">
        <div id="post-body">
            <div class="tnc-pdf-column-left">
                <div class="postbox">
                    <h3>Register PDF viewer for WordPress</h3>
                    <div class="inside">
                    	...
                    	if(!empty($get_sitekey)){
                    		echo "<h3 style='color:green;font-weight: bold;text-align: center;'>Congratulations! Your copy of PDF Viewer for WordPress is registered.</h3>";
                        ...
                        <div class="register-pvfw" style="<?php echo $reg_style; ?>" id="register-pvfw">
                        	<p>
                            Please enter your purchase key below to register your copy of PDF Viewer for WordPress to get automatic updates. If you don't have a purchase code yet, you can get that by clicking <a href="https://codecanyon.net/item/pdf-viewer-for-wordpress/8182815" target="_blank">here</a>. <br><br /><strong>Please note that, Every license/purchase key of PDF Viewer for WordPress is valid for only one site.</strong> <br /></p>
	                        ...
	                        <div class="form">
	                        	<form action="" method="POST">
	                        		...
	                        		<input type="submit" value="Register PDF Viewer for WordPress" class="button button-primary" />
	                        	</form>
	                        </div>
	                    </div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="deregister-pvfw" id="deregister-pvfw">
                            <p>
                            Please click on the button below to de-register this site from PDF Viewer for WordPress Updates.<strong>Every license of PDF Viewer for WordPress is valid for only one site.</strong> If you need additional license keys for PDF Viewer for WordPress, you can get that by clicking <a href="https://codecanyon.net/item/pdf-viewer-for-wordpress/8182815" target="_blank">here</a> <br> <br />
                            ...
                            <div class="form">
                                <form action="" method="POST">
                                    ...
                                    <input type="submit" value="De-Register PDF Viewer for WordPress" class="button button-warning" style="background: red;color: #fff;" />
                                </form>
                            </div>
                        </div>
