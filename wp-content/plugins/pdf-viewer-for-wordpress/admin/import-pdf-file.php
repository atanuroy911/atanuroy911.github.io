	...
	<div id="poststuff">
	    <div id="post-body">
		    <div class="tnc-upload-container">
		    	...
		    	<p><?php echo esc_html_e( "This page allows you easily import a file from web to your media library. The purpose of this page is to reduce the amount of work you need to do to download the file to computer and upload again to media library.", $domain = 'pdf-viewer-for-wordpress' ); ?></p>
